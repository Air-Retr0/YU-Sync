    ...
    <nav className="bg-red-600 p-4 flex items-center text-white">
      ...
      <div className="flex items-center space-x-4">
        <div className="dropdown">
          ...
          <ul
            tabIndex={0}
            className="menu menu-sm dropdown-content absolute bg-red-500 rounded-box z-[1] mt-3 w-52 p-2 text-black">
            <div className="drawer">
              ...
              <div className="drawer-side">
                ...
                {/* Idk why but to this UI Components bg-*-600 is the same as bg-*-500*/}
                <ul className="menu bg-red-600 text-base-content min-h-full w-80 p-4">
                  <li><a className='text-2xl text-white'>Services</a></li>
                  <br />
                  <li><a className='text-white'>Explore Courses</a></li>
                  <br />
                  <li><a className='text-white'>Elective Matcher (TBD)</a></li>
                  <br />
                  <li><a className='text-2xl text-white'>Information</a></li>
                  <br />

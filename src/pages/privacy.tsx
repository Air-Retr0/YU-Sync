            ...
            <div className="hero bg-white min-h-screen">
                <div className="text-center hero-content">
                    <div className="max-w-md">
                        <h1 className="mb-5 text-5xl font-bold text-red-500">Privacy Policy</h1>
                        <p className="mb-5">
                        ...
                        <p className="mb-5">
                            ...
                            improve the user experience and to ensure the site is functioning correctly. This information is not shared with any third-party entities and is not
                            used to identify you personally, but rather, the data helps us understand how users interact with the site.</p>
                        <h2 className="mb-5 text-2xl font-bold text-red-500">1.1. Cookies</h2>
                        <p className="mb-5">
                        ...
                        <h2 className="mb-5 text-2xl font-bold text-red-500">1.2. Non-Identifiable Data</h2>
                        <p className="mb-5">
                            Place holder for non-identifiable data
                        </p>
                        <h2 className="mb-5 text-2xl font-bold text-red-500">1.3. Third-Party Entities</h2>
                        <p className="mb-5">
                            YU Sync uses a variety of methods to secure user account information, such as passwords and usernames. Along this authentication process
                            is a method called "OAuth", OAuth is the method of security that the additional sign in options (Google, Facebook, etc.) use to authenticate your
                        ...
                        <p className="mb-5">
                            The information collected by YU Sync is primarily used to improve user experience and to ensure the site is functioning correctly.
                            We may also monitor the site's performance and usage to improve the quality of the site. The information collected is not used to identify
                            you personally, but rather, to understand how users interact with the site. The information collected is not shared with any third-party entities.
                        </p>
                        <h2 className="mb-5 text-2xl font-bold text-red-500">3. Your Choices</h2>
                        <p className="mb-5">
                            The YU Sync team recognizes your right to privacy and the collection and usage of your data:
                            <ul>
                                <li>You have the right to manage your cookie preferences through your browser. and acknowledge some services of YU Sync may function differently due to the change</li>
                                ...
                                <li>You have the right, if applicable, to opt out of any third party services through their instructions.</li>
                        ...
                        <p className="mb-5">
                            ...
                            these third-party services to understand how they collect and use your information, and further information on opting out should you wish for it.
                            A list of these third-party services can be found below:
                            <ul>
